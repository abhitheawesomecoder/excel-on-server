...
<?php endif; ?>
    ...
    <?= Form::input('text', $name.'_display',$options['display_value'], ['id'=>$name.'_display','class' => 'form-control manyToOne display_value','disabled' => 'disabled']) ?>
            ...
            <div class="input-group-addon">
                ...
                <i data-related-field="{{$name}}" data-route="{{$options['search_route']}}" data-modal-title="{{trans($options['modal_title'])}}" data-display="{{$options['relation_field']}}" class="material-icons search-relation-button">search</i>
            </div>
