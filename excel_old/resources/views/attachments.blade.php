...
<form id="fileupload" action="{{ route('core.ext.attachments.upload-attachments') }}" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" name="path" value="http://localhost:8000/accounts/accounts/9" />
    ...
    <div class="row fileupload-buttonbar">
        <div class="col-lg-12">
            <p class="font-bold">
                Allowed File Types: <span class="col-red">Jpg, Jpeg, Png, Pdf, Zip, Rar, Doc, Docx</span>
            </p>
        </div>
        <div class="col-lg-6">
...
<script>
    jQuery(document).ready(function() {
        ...
        $('#fileupload').fileupload({
            ...
            acceptFileTypes: /(\.|\/)({{ config('attachments.file_upload_types')}})$/i,
        });
