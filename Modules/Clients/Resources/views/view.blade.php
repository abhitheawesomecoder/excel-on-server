...
<div class="header">
                    <h2>
                        <div class="header-buttons">
                            @if($title == 'core.client.view.title')
                            @if(Auth::user()->hasRole('Super Admin'))
                            <a href="{{route('clients.index').'/'.$id.'/delete'}}" title="Delete" class="btn btn-primary btn-back btn-crud">Delete</a>
                            @endif
                            <a href="{{route('clients.edit',$id)}}" title="Edit" class="btn btn-primary btn-back btn-crud">Edit</a>
                           @endif
                        </div>
